...
def genera_dati_clienti(num_clienti, pesi_citta, seed=42):
    ...
    conditions = [
        (df_clienti['eta'] < 25),
        (df_clienti['eta'] >= 25) & (df_clienti['eta'] < 35),
        (df_clienti['eta'] >= 35) & (df_clienti['eta'] < 50),
        (df_clienti['eta'] >= 50) & (df_clienti['eta'] < 65),
        (df_clienti['eta'] >= 65)
    ]
    fascia_eta = ['18-24', '25-34', '35-49', '50-64', '65+']
    df_clienti['fascia_eta'] = np.select(conditions, fascia_eta)
